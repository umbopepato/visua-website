...
const visua_1 = require("../../visua");
const path = require("path");
exports.run = (options, args) => {
    let styleMap;
    try {
        styleMap = visua_1.visua({
            path: options.path,
    ...
    for (let pluginArgs of pluginsArgs) {
        ...
        try {
            ...
            logger_1.logger.error(`Error: Cannot find plugin named visua-${pluginArgs[0]}.\n\n` +
        ...
        if (plugin != null) {
            ...
            try {
                ...
                logger_1.logger.error(e.formattedMessage || e.stack || e);
                logger_1.logger.warn(`An error occurred during the execution of the ${pluginArgs[0]} plugin (see above).`);
            }
        }
    }
};
